...
/*
 * Function for writing the size in hexadecimal to the field
 *
 * @param char *p_array	      Buffer for hexadecimal writting
 * @param array_size	      Number
 *
 */
void convert_size_hex(unsigned char *p_array, 
                     uint32_t array_size);
#endif
